            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    >
                        <CircleFill
                            className={`text-gold me-2 ${
                                activeTab === "plans" ? "d-inline" : "d-none"
                            }`}
                ...
                >
                    ...
                    >
                        <CircleFill
                            className={`text-gold me-2 ${
                                activeTab === "channels" ? "d-inline" : "d-none"
                            }`}
                            style={{ fontSize: "x-small" }}
                        />
                        CHANNELS
                ...
                >
                    ...
                    >
                        <CircleFill
                            className={`text-gold me-2 ${
                                activeTab === "about" ? "d-inline" : "d-none"
                            }`}
                            style={{ fontSize: "x-small" }}
                        />
                        ABOUT US
                ...
                >
                    ...
                    >
                        <CircleFill
                            className={`text-gold me-2 ${
                                activeTab === "contact" ? "d-inline" : "d-none"
                            }`}
                            style={{ fontSize: "x-small" }}
                        />
                        CONTACT US
                ...
                >
                    ...
                    >
                        <CircleFill
                            className={`text-gold me-2 ${
                                activeTab === "services" ? "d-inline" : "d-none"
                            }`}
                            style={{ fontSize: "x-small" }}
                        />
                        SERVICE CATALOG
